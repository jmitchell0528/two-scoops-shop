...
/***/ function(module, exports, __webpack_require__) {
	...
	var App = function (_Component) {
	  ...
	  _createClass(App, [{
	    key: 'addToCart',
	    value: function addToCart(flavors) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _shop = __webpack_require__(247);
	...
	*/
	exports.default = _react2.default.createElement(
	  ...
	  _react2.default.createElement(
	    ...
	    _react2.default.createElement(_reactRouter.IndexRoute, { component: _shop2.default }),
	    _react2.default.createElement(_reactRouter.Route, { path: 'flavors/:id', component: _detail2.default }),
	...
	var Shop = function (_Component) {
	  ...
	  _createClass(Shop, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      return _axios2.default.get('http://localhost:3000/flavors').then(function (response) {
	        return _this2.setState({ flavors: response.data });
	      }).catch(function (err) {
	    ...
	    key: 'renderFlavors',
	    value: function renderFlavors() {
	      return this.state.flavors.map(function (flavor) {
	        return _react2.default.createElement(
	          'div',
	          { key: flavor.id },
	          _react2.default.createElement(
	            _reactRouter.Link,
	            { to: '/flavors/' + flavor.id, className: 'flavor-link' },
	            flavor.name
	          )
	        );
	      });
	...
	var Cart = function (_Component) {
	  ...
	  _createClass(Cart, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      return _axios2.default.get('http://localhost:3000/cart').then(function (response) {
	        return _this2.setState({ items: response.data });
	      }).catch(function (err) {
	        return console.error(err);
	      });
	    }
	    ...
	    value: function renderCartItems() {
	      return this.state.items.map(function (item) {
	        ...
	        return _react2.default.createElement(
	          'div',
	          { key: item.id, className: 'push--bottom' },
	          ...
	          item.popularity && _react2.default.createElement(
	            'h3',
	            null,
	            'Popularity: ',
	            item.popularity
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Detail = function (_Component) {
	  ...
	  function Detail(props) {
	    ...
	    _this.state = { item: {}, loading: false, message: '' };
	    return _this;
	  }
	  ...
	  _createClass(Detail, [{
	    ...
	    value: function componentWillMount() {
	      ...
	      return _axios2.default.get('http://localhost:3000/flavors/' + id).then(function (response) {
	        return _this2.setState({ item: response.data });
	      }).catch(function (err) {
	        return console.error(err);
	      });
	    }
	    ...
	    value: function addToCart(item) {
	      ...
	      return _axios2.default.post('http://localhost:3000/cart', item).then(function (response) {
	        return _this3.setState({ message: 'Added To Cart' });
	      }).catch(function (err) {
	        return _this3.setState({ message: 'Error adding to cart' });
	      });
	    }
	  }, {
	    key: 'render',
	    value: function render() {
	      ...
	      return _react2.default.createElement(
	        ...
	        item.id && _react2.default.createElement(
	          'button',
	          {
	            onClick: function onClick() {
	              return _this4.addToCart(item);
	            },
	            className: 'btn btn-sm push--top'
	          },
	          'Add to Cart'
	        )
	      );
